...
export function SheetSystemSwitcher({ active }: { active: SystemId }) {
  const options: Array<{ id: SystemId; label: string; href: string }> = [{ id: "vampiro-v5", label: "Vampiro: A Máscara V5", href: "/ficha-v5" }, { id: "cacador-a-vinganca", label: "Caçador: A Revanche", href: "/ficha-cacador" }, { id: "o-um-anel", label: "O Um Anel", href: "/ficha-um-anel" }];
